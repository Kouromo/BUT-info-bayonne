...
public:
    ...
    void setupUi(QMainWindow *ChifoumiVue)
    {
        ...
        actionParam_trer = new QAction(ChifoumiVue);
        actionParam_trer->setObjectName(QString::fromUtf8("actionParam_trer"));
        ...
        lGagne = new QLabel(centralwidget);
        lGagne->setObjectName(QString::fromUtf8("lGagne"));

        gridLayout_2->addWidget(lGagne, 0, 2, 1, 1, Qt::AlignHCenter);

        lPointGagnant = new QLabel(centralwidget);
        lPointGagnant->setObjectName(QString::fromUtf8("lPointGagnant"));

        gridLayout_2->addWidget(lPointGagnant, 1, 2, 1, 1, Qt::AlignHCenter);
        ...
        verticalLayout->addLayout(hLayoutDuel);

        horizontalLayout_3 = new QHBoxLayout();
        horizontalLayout_3->setObjectName(QString::fromUtf8("horizontalLayout_3"));
        lTemps = new QLabel(centralwidget);
        lTemps->setObjectName(QString::fromUtf8("lTemps"));

        horizontalLayout_3->addWidget(lTemps, 0, Qt::AlignHCenter);

        lSecondes = new QLabel(centralwidget);
        lSecondes->setObjectName(QString::fromUtf8("lSecondes"));

        horizontalLayout_3->addWidget(lSecondes, 0, Qt::AlignHCenter);
        ...
        menuFichier->addAction(actionParam_trer);
        menuFichier->addAction(actionQuitter);
        menuAide->addAction(actionA_propos_de);

        retranslateUi(ChifoumiVue);
        QObject::connect(actionQuitter, SIGNAL(triggered()), ChifoumiVue, SLOT(close()));
    ...
    void retranslateUi(QMainWindow *ChifoumiVue)
    {
...
#endif // QT_CONFIG(shortcut)
        actionParam_trer->setText(QCoreApplication::translate("ChifoumiVue", "Param\303\251trer", nullptr));
        lMachine->setText(QCoreApplication::translate("ChifoumiVue", "La Machine", nullptr));
        ...
        lGagne->setText(QCoreApplication::translate("ChifoumiVue", "Gagnant \303\240", nullptr));
        lPointGagnant->setText(QCoreApplication::translate("ChifoumiVue", "points", nullptr));
        lImageDuel->setText(QString());
        lTemps->setText(QCoreApplication::translate("ChifoumiVue", "Tps restant (s) :", nullptr));
        lSecondes->setText(QCoreApplication::translate("ChifoumiVue", "s", nullptr));
        ...
        bPause->setText(QCoreApplication::translate("ChifoumiVue", "Pause", nullptr));
